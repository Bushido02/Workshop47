...
public class ResourceCosts {
    ...
    //Formix
    public static final ResourceCost FORMIX_WORKER = new ResourceCost(ID, "FORMIX_WORKER");
    public static final ResourceCost FORMIX_WARRIOR = new ResourceCost(ID, "FORMIX_WARRIOR");
    ...
    //Formix
    public static final ResourceCost FORMIX_HIVE = new ResourceCost(ID, "FORMIX_HIVE");
    ...
    public static void deferredLoadResourceCosts() {
        ...
        FORMIX_WORKER.bakeValues(ReignOfNetherCommonConfigs.UnitCosts.FORMIX_WORKER);
        FORMIX_WARRIOR.bakeValues(ReignOfNetherCommonConfigs.UnitCosts.FORMIX_WARRIOR);
        ...
        FORMIX_HIVE.bakeValues(ReignOfNetherCommonConfigs.BuildingCosts.FORMIX_HIVE);
