...
import com.solegendary.reignofnether.playerprogression.FormixPlayerProgressionClientboundPacket;
...
public final class PacketHandler {
    ...
    public static void init() {
        ...
        INSTANCE.messageBuilder(FormixPlayerProgressionClientboundPacket.class, index++, NetworkDirection.PLAY_TO_CLIENT)
