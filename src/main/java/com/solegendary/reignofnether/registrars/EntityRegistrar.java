...
import com.solegendary.reignofnether.unit.units.formix.*;
...
public class EntityRegistrar {
    ...
    public static final RegistryObject<EntityType<FormixWorkerUnit>> FORMIX_WORKER_UNIT = ENTITIES.register("formix_worker_unit",
            () -> EntityType.Builder.of(FormixWorkerUnit::new, MobCategory.CREATURE)
                    .sized(EntityType.ZOMBIE.getWidth(), EntityType.ZOMBIE.getHeight())
                    .clientTrackingRange(UNIT_CLIENT_TRACKING_RANGE)
                    .build(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "formix_worker_unit").toString()));

    public static final RegistryObject<EntityType<FormixWarriorUnit>> FORMIX_WARRIOR_UNIT = ENTITIES.register("formix_warrior_unit",
            () -> EntityType.Builder.of(FormixWarriorUnit::new, MobCategory.CREATURE)
                    .sized(EntityType.ZOMBIE.getWidth(), EntityType.ZOMBIE.getHeight())
                    .clientTrackingRange(UNIT_CLIENT_TRACKING_RANGE)
                    .build(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "formix_warrior_unit").toString()));
    ...
    public static EntityType<? extends Mob> getEntityType(String unitName) {
        return switch(unitName) {
            ...
            case FormixWorkerProd.itemName -> EntityRegistrar.FORMIX_WORKER_UNIT.get();
