...
public class ProductionItems {
    ...
    public static final FormixWorkerProd FORMIX_WORKER = register(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "formix_worker"), new FormixWorkerProd());
