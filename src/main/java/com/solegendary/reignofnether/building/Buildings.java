...
import com.solegendary.reignofnether.building.buildings.formix.*;
...
public class Buildings {
    ...
    public static final FormixHive FORMIX_HIVE = register(ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "formix_hive"), new FormixHive());
