...
public class CommonModEvents {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent evt) {
        ...
        evt.put(EntityRegistrar.FORMIX_WORKER_UNIT.get(), FormixWorkerUnit.createAttributes().build());
        evt.put(EntityRegistrar.FORMIX_WARRIOR_UNIT.get(), FormixWarriorUnit.createAttributes().build());
