...
public class StartButtons {
    ...
    public static Button formixStartButton = new Button(
            "Formix",
            ICON_SIZE,
            ResourceLocation.fromNamespaceAndPath(ReignOfNether.MOD_ID, "textures/mobheads/formix_worker.png"),
            (Keybinding) null,
            () -> CursorClientEvents.getLeftClickAction() == UnitAction.STARTRTS_FORMIX,
            () -> TutorialClientEvents.isEnabled() || !PlayerClientEvents.canStartRTS,
            () -> !TutorialClientEvents.isEnabled(),
            () -> CursorClientEvents.setLeftClickAction(UnitAction.STARTRTS_FORMIX),
            null,
            List.of(
