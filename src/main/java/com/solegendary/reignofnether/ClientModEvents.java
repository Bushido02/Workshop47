...
public class ClientModEvents {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers evt) {
        ...
        evt.registerEntityRenderer(EntityRegistrar.FORMIX_WORKER_UNIT.get(), FormixWorkerRenderer::new);
        evt.registerEntityRenderer(EntityRegistrar.FORMIX_WARRIOR_UNIT.get(), FormixWarriorRenderer::new);
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(FormixWorkerModel.LAYER_LOCATION, FormixWorkerModel::createBodyLayer);
        event.registerLayerDefinition(FormixWarriorModel.LAYER_LOCATION, FormixWarriorModel::createBodyLayer);
