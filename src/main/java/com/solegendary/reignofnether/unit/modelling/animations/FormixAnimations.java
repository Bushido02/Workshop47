...
// PLACEHOLDER animations for the Formix faction.
// Replace the contents of this class with the AnimationDefinition classes exported directly
// from Blockbench once the final Formix worker/warrior models are ready (Blockbench > File >
// Export > Export Animations, "paste into your mod" style output like WraithAnimations.java).
