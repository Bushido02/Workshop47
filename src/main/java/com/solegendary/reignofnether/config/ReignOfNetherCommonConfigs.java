...
public class ReignOfNetherCommonConfigs {
    ...
    static {
        ...
        UnitCosts.FORMIX_WORKER.define(BUILDER);
        UnitCosts.FORMIX_WARRIOR.define(BUILDER);
        ...
        BuildingCosts.FORMIX_HIVE.define(BUILDER);
    ...
    public static class BuildingCosts implements Costs {
        ...
        public static final ResourceCostConfigEntry FORMIX_HIVE = ResourceCostConfigEntry.Building(0, 400, 0, 5, ResourceCosts.FORMIX_HIVE, "Formix Hive Config");
