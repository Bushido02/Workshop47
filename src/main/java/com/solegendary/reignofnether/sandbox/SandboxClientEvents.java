...
public class SandboxClientEvents {
    ...
    public static List<BuildingPlaceButton> getBuildingButtons() {
        return switch (faction) {
            ...
            case FORMIX -> FormixWorkerUnit.getBuildingButtons();
    ...
    public static List<UnitSpawnButton> getUnitButtons() {
        return switch (faction) {
            ...
            case FORMIX -> List.of(
                ProductionItems.FORMIX_WORKER.getPlaceButton()
            );
            default -> List.of(
        ...
        return new Button(
                ...
                () -> {
                    switch (faction) {
                        ...
                        case PIGLINS -> faction = Faction.FORMIX;
                        case FORMIX -> faction = Faction.NONE;
                ...
                () -> {
                    switch (faction) {
                        ...
                        case FORMIX -> faction = Faction.PIGLINS;
                        default -> faction = Faction.FORMIX;
                    }
                },
                List.of(
                        ...
                        fcs(I18n.get("hud.faction.reignofnether.formix"), faction == Faction.FORMIX),
