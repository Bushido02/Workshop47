    ...
    public static void startRTS(Faction faction, Double x, Double y, Double z) {
        ...
        if (MC.player != null && MC.level != null) {
            ...
            PlayerAction playerAction = switch (faction) {
                ...
                case FORMIX -> PlayerAction.START_RTS_FORMIX;
    ...
    public boolean handle(Supplier<NetworkEvent.Context> ctx) {
        ...
        ctx.get().enqueueWork(() -> {
            ...
            switch (action) {
                ...
                case START_RTS_FORMIX ->
                    PlayerServerEvents.startRTS(this.playerId, new Vec3(this.x, this.y, this.z), Faction.FORMIX);
